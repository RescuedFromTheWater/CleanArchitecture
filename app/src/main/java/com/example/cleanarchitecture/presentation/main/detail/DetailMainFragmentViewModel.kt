...
import com.example.cleanarchitecture.domain.product.usecase.DeleteProductByIdUseCase
import com.example.cleanarchitecture.domain.product.usecase.GetProductByIdUseCase
import com.example.cleanarchitecture.domain.product.usecase.UpdateProductUseCase
...
@HiltViewModel
class DetailMainFragmentViewModel
@Inject constructor(
