package com.example.cleanarchitecture.presentation.main.home
...
import com.example.cleanarchitecture.databinding.FragmentMainHomeBinding
import com.example.cleanarchitecture.domain.product.entity.ProductEntity
import com.example.cleanarchitecture.presentation.common.extension.gone
import com.example.cleanarchitecture.presentation.common.extension.showToast
import com.example.cleanarchitecture.presentation.common.extension.visible
...
class HomeMainFragment : Fragment(R.layout.fragment_main_home) {
    ...
    private fun handleState(state: HomeMainFragmentState){
        when(state){
            is HomeMainFragmentState.IsLoading ->
                handleLoading(state.isLoading)
            is HomeMainFragmentState.ShowToast ->
