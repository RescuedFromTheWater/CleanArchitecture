...
import com.example.cleanarchitecture.databinding.ItemProductBinding
import com.example.cleanarchitecture.domain.product.entity.ProductEntity

class HomeMainProductAdapter(
    private val products: MutableList<ProducwtEntity>
) : RecyclerView.Adapter<HomeMainProductAdapter.ViewHolder>(){
    interface OnItemTap {
    ...
    override fun onBindViewHolder(
        holder: ViewHolder,
        position: Int) = holder.bind(products[position])
